<?php
    ...
    echo "<img src='images/thankyou.svg' style='border: 5px solid black;  position: absolute;  top: 40%;  left: 50%;  transform: translate(-50%, -50%);  padding: 10px; color: green;'>ขอบคุณที่ใช้บริการ...";
